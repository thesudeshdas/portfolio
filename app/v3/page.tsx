...
import V3RevealGroup from '@/components/V3RevealGroup/V3RevealGroup';
  ...
  return (
    ...
    >
      ...
      <article className='mx-auto max-w-[680px] px-6 py-16 sm:px-8 sm:py-24'>
        ...
        <section className='mb-14'>
          <V3RevealGroup className='flex flex-col gap-10'>
            <p className='text-[15px] font-semibold tracking-[0.15em] text-[#7a5a3e] dark:text-[#b89a78]'>
