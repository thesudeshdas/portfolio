...
Designed a responsive auto-scaling design system based on a 390px iPhone baseline with custom Tailwind presets. Resolved 10+ Android-specific rendering issues including font family splitting, BlurView compatibility, and CSS border alternatives via SVG.

Integrated Mixpanel analytics and Sentry error monitoring across all feature modules.
