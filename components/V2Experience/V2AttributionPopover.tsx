    ...
    >
      ...
      <Dialog.Portal>
        <Dialog.Overlay asChild>
          <motion.div
            className='fixed inset-0 z-[14000] bg-black/70'
        ...
        <Dialog.Content
          data-v2-content-cursor='true'
          className='fixed top-1/2 left-1/2 z-[14010] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 focus:outline-none'
        >
          <motion.div
