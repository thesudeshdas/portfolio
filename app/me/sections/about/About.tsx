  ...
  return (
    <div className='flex flex-col gap-4 text-sm font-light md:max-w-[60%]'>
      ...
      <p>
        ...
        about my life and experiences (mainly related to motorcycling). Outside
        of tech and motorcycles, I enjoy football (Hala Madrid!), video games
        and doom-scrolling.
      </p>

      <p>
        If you are someone who has overlapping interest(s), feel free to HMU on
